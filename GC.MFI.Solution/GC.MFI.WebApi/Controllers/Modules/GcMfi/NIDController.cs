    ...
    public class NIDController : ControllerBase
    {
        ...
        public async Task<NIDVerificationResponse> VerifyNID(NIDVerificationRequest req)
        {
            try
            {
                ...
                var nidResponse=  new NIDVerificationResponse
                {
                    data = new Data
                    {
                        nid = new Nid
                ...
                var responseJson = JsonConvert.SerializeObject(nidResponse);

                var nidLog = new NIDLogging()
                {
