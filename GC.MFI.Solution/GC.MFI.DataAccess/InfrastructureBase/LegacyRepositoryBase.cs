...
{
    public class LegacyRepositoryBase<TDbModel> : ILegacyRepository<TDbModel>
        where TDbModel : class, ILegacyDbModelBase
    {
        ...
        public LegacyRepositoryBase(IDatabaseFactory databaseFactory)
        {
            DatabaseFactory = databaseFactory;
            _dbset = DataContext.Set<TDbModel>();
        }
